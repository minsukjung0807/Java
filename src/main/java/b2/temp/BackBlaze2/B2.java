...
import b2.temp.BackBlaze2.listeners.ProgressRequestBody;
import b2.temp.BackBlaze2.models.*;
import com.google.gson.Gson;
import com.google.gson.JsonObject;
import com.squareup.okhttp.*;
import b2.temp.BackBlaze2.models.Callback;
    ...
    public B2UploadInfo getUploadInfo(final String bucketId) {
        ...
        try {
            ...
            if (response.isSuccessful() && response.body() != null) {
                ...
                JSONObject json = new JSONObject(response.body().string());
                System.out.println("업로드 정보 가져오기 실패!!");
                System.exit(0);
            }
